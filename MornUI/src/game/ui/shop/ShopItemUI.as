	...
	public class ShopItemUI extends View {
		...
		protected static var uiXML:XML =
			<View width="453" height="165">
			  <Image skin="png.main.item_bg" x="0" y="0" sizeGrid="20,20,20,20" width="453" height="165"/>
			  <Image skin="png.main.shop1_5" x="21" y="6" width="152" height="143" var="dogImg"/>
			  ...
			  <Label text="小土狗" x="162" y="31" width="271" height="44" align="left" size="40" var="nameLabel"/>
			  <Label text="1星" x="168" y="96" width="56" height="44" align="left" size="35" var="starLabel"/>
			  <Label text="1" x="-18" y="71" width="40" height="37" align="center" size="35" var="indexLabel"/>
			</View>;
