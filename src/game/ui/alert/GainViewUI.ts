namespace ui 
{
	export class GainViewUI extends morn.View
	{
		...
		protected createChildren():void
		{
			...
			t.goldImg1 = new morn.Image
			this.addChild(t.goldImg1)
			t.goldImg1.skin = "main_json.gold_3"
			t.goldImg1.x = 239
			t.goldImg1.y = 438
			...
			t.goldImg2.x = 241
			t.goldImg2.y = 467
			t.goldImg2.visible = false
			t.goldImg3 = new morn.Image
			this.addChild(t.goldImg3)
			t.goldImg3.skin = "main_json.gold_1"
			t.goldImg3.x = 262
			t.goldImg3.y = 481
			t.goldImg3.visible = false
